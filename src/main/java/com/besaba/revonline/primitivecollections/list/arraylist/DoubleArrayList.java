 ...
 *
 *  - Serialize number of double (size -- n)
 *  - Send n double
 *
 * @author Marco
 * @since 1.0
...
public class DoubleArrayList
        implements DoubleIterable, RandomAccess, Cloneable, Serializable {
    ...
    /**
     * Creates an DoubleArrayList with the provided capacity.
     *
     * @param capacity The start capacity
     * @return The created DoubleArrayList
     */
    ...
    /**
     * Creates an DoubleArrayList taking the values from another ArrayListInt
     *
     * @param fromList The original list
     * @return The DoubleArrayList which contains {@see fromList} values
     */
    ...
    /**
     * Creates an DoubleArrayList with the values provided as argument
     *
     ...
     * @return An DoubleArrayList with the values provided as arguments
     */
    ...
    /**
     * Adds an double at the end of the list.
     *
    ...
    private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.elementsData = new double[size];
    ...
    private void writeObject(final ObjectOutputStream out) throws IOException {
        ...
        out.writeInt(size);
        for (final double i : elementsData) {
            out.writeDouble(i);
        }
    }
}
