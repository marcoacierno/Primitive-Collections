 ...
 *
 *  - Serialize number of char (size -- n)
 *  - Send n char
 *
 * @author Marco
 * @since 1.0
...
public class CharArrayList
        implements CharIterable, RandomAccess, Cloneable, Serializable {
    ...
    /**
     * Creates an CharArrayList with the provided capacity.
     *
     * @param capacity The start capacity
     * @return The created CharArrayList
     */
    ...
    /**
     * Creates an CharArrayList taking the values from another ArrayListInt
     *
     * @param fromList The original list
     * @return The CharArrayList which contains {@see fromList} values
     */
    ...
    /**
     * Creates an CharArrayList with the values provided as argument
     *
     ...
     * @return An CharArrayList with the values provided as arguments
     */
    ...
    /**
     * Adds an char at the end of the list.
     *
    ...
    private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.elementsData = new char[size];
