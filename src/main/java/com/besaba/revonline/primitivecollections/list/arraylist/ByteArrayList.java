 ...
 *
 *  - Serialize number of byte (size -- n)
 *  - Send n byte
 *
 * @author Marco
 * @since 1.0
...
public class ByteArrayList
        implements ByteIterable, RandomAccess, Cloneable, Serializable {
    ...
    /**
     * Creates an ByteArrayList with the provided capacity.
     *
     * @param capacity The start capacity
     * @return The created ByteArrayList
     */
    ...
    /**
     * Creates an ByteArrayList taking the values from another ArrayListInt
     *
     * @param fromList The original list
     * @return The ByteArrayList which contains {@see fromList} values
     */
    ...
    /**
     * Creates an ByteArrayList with the values provided as argument
     *
     ...
     * @return An ByteArrayList with the values provided as arguments
     */
    ...
    /**
     * Adds an byte at the end of the list.
     *
    ...
    private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.elementsData = new byte[size];
